...
%XILINX_SDK_PATH%\eclipse\win64.o\eclipsec --launcher.suppressErrors -vm %XILINX_SDK_PATH%/tps/win64/jre/bin -nosplash -application org.eclipse.cdt.managedbuilder.core.headlessbuild -import "%HW0%" -import "%BSP0%" -import "%APP0%" -import "%APP1%" -data %WS% -vmargs -Dorg.eclipse.cdt.core.console=org.eclipse.cdt.core.systemConsole
