...
set_property PACKAGE_PIN T4 [get_ports AC_ADC_SDATA]
set_property IOSTANDARD LVCMOS33 [get_ports AC_ADC_SDATA]
set_property PACKAGE_PIN T5 [get_ports AC_BCLK]
set_property IOSTANDARD LVCMOS33 [get_ports AC_BCLK]
set_property PACKAGE_PIN W6 [get_ports AC_DAC_SDATA]
set_property IOSTANDARD LVCMOS33 [get_ports AC_DAC_SDATA]
set_property PACKAGE_PIN U5 [get_ports AC_LRCLK]
set_property IOSTANDARD LVCMOS33 [get_ports AC_LRCLK]
set_property PACKAGE_PIN U6 [get_ports AC_MCLK]
...
set_property PACKAGE_PIN AA16 [get_ports mdio_rtl_mdc]
set_property IOSTANDARD LVCMOS25 [get_ports mdio_rtl_mdc]
set_property PACKAGE_PIN Y16 [get_ports mdio_rtl_mdio_io]
set_property IOSTANDARD LVCMOS25 [get_ports mdio_rtl_mdio_io]
