...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = d_sd_demo_0
END
...
BEGIN DRIVER
 ...
 PARAMETER DRIVER_VER = 3.0
 PARAMETER HW_INSTANCE = video_v_tpg_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.0
 PARAMETER HW_INSTANCE = video_video_path_ctrl
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER DRIVER_VER = 6.1
 PARAMETER HW_INSTANCE = video_vtd
END
